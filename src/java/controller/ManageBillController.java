...
public class ManageBillController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (service.equals("listAll")) {
            ArrayList<BillDetailForAdmin> billDetailForAdmins = (new BillDAO()).showBillDetailForAdmin();
        ...
        if (service.equals("showDetailBill")) {
            ...
            ArrayList<BillDetail> billDetails = (new BillDAO()).showBillDetail(billId);
        ...
        if (service.equals("filterStatus")) {
            ...
            ArrayList<BillDetailForAdmin> bdfas = new ArrayList<>();
